...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 relative overflow-hidden transition-colors duration-300">
      ...
      <section className="max-w-7xl mx-auto px-6 pt-16 pb-16 z-10 relative text-center max-w-4xl">
        <div className="space-y-6">
          ...
          <p className="text-base sm:text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed font-normal">
            Personal portal at <span className="text-indigo-400 font-semibold">ponyapp.net</span>. Software applications ecosystem, enterprise AI strategy, software engineering case studies, and photography by <span className="text-white font-extrabold underline decoration-indigo-500/50 underline-offset-4">Yarnin Peled</span>.
          </p>

          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <Link
              href="#apps"
              className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-3 px-6 rounded-xl transition-all shadow-lg shadow-indigo-600/20"
            >
            ...
            <Link
              href="#articles"
              className="flex items-center gap-2 glass-panel hover:bg-slate-800 text-slate-200 font-medium py-3 px-5 rounded-xl border border-slate-700 transition-all"
            >
              <BookOpen className="w-4 h-4 text-indigo-400" />
              <span>Enterprise AI Insights</span>
            </Link>
          </div>
        </div>
      </section>

      {/* Section 1: Balanced Ecosystem Apps Grid */}
      <section id="apps" className="max-w-7xl mx-auto px-6 py-12 border-t border-slate-900">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Ecosystem Applications</h2>
            <p className="text-sm text-slate-400 mt-1">Web applications built and hosted under ponyapp.net</p>
          </div>
        </div>
      ...
      {/* Section 2: Enterprise AI Insights & Articles */}
      <section id="articles" className="max-w-7xl mx-auto px-6 py-12 border-t border-slate-900">
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-xs font-semibold mb-2">
            ...
            <span>AI Strategy & Operations</span>
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold text-white">Enterprise AI Insights</h2>
          <p className="text-sm text-slate-400 mt-1">Short articles on AI adoption, workflow integration, and governance by Yarnin Peled</p>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-1.5 pt-2">
                  {article.tags.map((tag, idx) => (
                    <span
                      key={idx}
                      className="text-[10px] bg-slate-900 border border-slate-800 text-indigo-300 px-2 py-0.5 rounded-md"
                    >
                      {tag}
                    </span>
                  ))}
      ...
      {/* Section 4: Photography Spotlight (yarninpeled.com) */}
