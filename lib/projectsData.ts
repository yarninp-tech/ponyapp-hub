...
export const PROJECTS_DATA: ProjectItem[] = [
  ...
  },
  {
    ...
    category: 'Ecosystem App',
    description: 'Full-featured browser PDF editor and AI document reader deployed at pony4app.web.app (pdf-editor.ponyapp.net).',
    ...
    highlights: [
      ...
      'Deploys live as a standalone sub-app at pony4app.web.app (pdf-editor.ponyapp.net)',
    ],
    techStack: ['React', 'Firebase Hosting', 'Firebase Auth', 'PDF.js', 'TypeScript', 'Tailwind CSS'],
    isLive: true,
    statusBadge: 'LIVE APP',
    launchUrl: 'https://pony4app.web.app',
    iconName: 'FileText',
