...
export const PROJECTS_DATA: ProjectItem[] = [
  ...
  },
  {
    ...
    isLive: true,
    statusBadge: 'LIVE APP',
    launchUrl: 'https://stokapp.ponyapp.net',
    iconName: 'Package',
  ...
  },
  {
    id: 'book-a-show',
    title: 'Book a Show',
    subtitle: 'Venue Date-Booking, Pricing Engine & Contracting System',
    category: 'Ecosystem App',
    description: 'A single-venue date-booking and contracting system managing availability, revenue-ranked overlap resolution, freeze-on-quote pricing, dual-signature PDF contracts, and read-only partner API.',
    fullOverview: 'Book a Show manages the full path from availability lookup to signed contract for a performance venue. Built with Next.js App Router, PostgreSQL, Prisma, NextAuth, dual client/server PDF generation engines, and a versioned Partner API.',
    highlights: [
      'Revenue-ranked overlap engine resolving competing producer requests',
      'Freeze-on-quote pricing integrity protecting contracted rate snapshots',
      'Dual-signature in-browser PDF engine for commitment forms & final agreements',
      'Read-only Partner API (v1) with Bearer SHA-256 keys & strict scope isolation',
      'Includes complete 2-Part specification suite: User Guide & Technical Reference',
    ],
    techStack: ['Next.js App Router', 'PostgreSQL', 'Prisma', 'NextAuth', 'TypeScript', 'Tailwind CSS'],
    isLive: true,
    statusBadge: 'LIVE APP',
    launchUrl: 'https://book-a-show.ponyapp.net',
    iconName: 'Theater',
    tags: ['Next.js App Router', 'PostgreSQL', 'Prisma', 'Partner API', 'PDF Contracts'],
  },
  {
    id: 'mscheduler',
    title: 'MScheduler',
