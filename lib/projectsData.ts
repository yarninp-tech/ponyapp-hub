...
export const PROJECTS_DATA: ProjectItem[] = [
  ...
  {
    id: 'doc-viewer',
    title: 'Interactive Document Intelligence Reader',
    subtitle: 'AI Contract Extraction & Variable Data Ingestion',
    category: 'Case Study & Interactive Tool',
    description: 'Autonomous extraction of critical data from complex legal tenancy agreements and enterprise documents directly into database schemas.',
    fullOverview: 'Inspired by Yarnin Peled\'s published research on replacing legacy software with AI agents, this tool demonstrates autonomous data extraction from tenancy legal agreements, converting unstructured PDF text directly into structured SQL/JSON databases.',
    highlights: [
      'Autonomous extraction of tenancy dates, fee escalations, and lease renewals',
      'Eliminates manual administrative data entry and human error risks',
      'Proactive agent notifications for contract expirations & compliance',
      'Interactive iframe document viewer container embedded directly into the hub',
    ],
    techStack: ['TypeScript', 'Node.js', 'Document AI', 'Python/SQL Pipeline', 'PDF Parser'],
    isLive: false,
    statusBadge: 'INTERACTIVE TOOL',
    iconName: 'FileText',
    tags: ['AI Document AI', 'Python', 'SQL', 'Contract Extraction'],
  },
  {
    id: 'stok-app',
    title: 'StokApp',
